...
class LanciumSweeper(BaseSweeper):
    ...
    def kill_workers(self, workspec_list):
        ...
        for workspec in workspec_list:
            tmp_log.debug(f"Running kill_worker for {workspec.workerID}")
    ...
    def kill_worker(self, workspec):
        tmp_log = self.make_logger(base_logger, f"workerID={workspec.workerID}", method_name="kill_worker")
    ...
    def sweep_worker(self, workspec):
        ...
        tmp_log = self.make_logger(base_logger, f"workerID={workspec.workerID}", method_name="sweep_worker")
